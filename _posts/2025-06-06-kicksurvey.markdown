...
---
  ...
  Using Gaussian process regression and transformation sampling, we predict that there should be approximately 8000 such BRCs detectable out to redshift $z=0.6$.
